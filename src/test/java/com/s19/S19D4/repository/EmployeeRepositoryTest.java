package com.s19.S19D4.repository;
...
class EmployeeRepositoryTest {
    ...
    @Test
    @DisplayName(value = "find employee by email ")
    void findByEmail(){
        String nonExistEmail = "kerem1@gmail.com";
        Optional<Employee> employeeOptional = employeeRepository.findByEmail(nonExistEmail);
        assertNotNull(employeeOptional.get());
        assertEquals("kerem", employeeOptional.get().getFirstName());
        assertEquals(3000d, employeeOptional.get().getSalary());
    }
